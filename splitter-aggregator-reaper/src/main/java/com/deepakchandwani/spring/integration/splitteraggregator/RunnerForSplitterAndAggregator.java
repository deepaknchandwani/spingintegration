...
public final class RunnerForSplitterAndAggregator {

	private static final Log LOGGER = LogFactory.getLog(RunnerForSplitterAndAggregator.class);

	private RunnerForSplitterAndAggregator() { }
